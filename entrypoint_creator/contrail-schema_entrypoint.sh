...
if [ _n "$contrail_schema__DEFAULTS__log_file" ]; then
  ./openstack_config __set /etc/contrail/contrail_schema.conf DEFAULTS log_file $contrail_schema__DEFAULTS__log_file
fi
if [ _n "$contrail_schema__DEFAULTS__log_local" ]; then
  ./openstack_config __set /etc/contrail/contrail_schema.conf DEFAULTS log_local $contrail_schema__DEFAULTS__log_local
fi
if [ _n "$contrail_schema__DEFAULTS__log_level" ]; then
  ./openstack_config __set /etc/contrail/contrail_schema.conf DEFAULTS log_level $contrail_schema__DEFAULTS__log_level
fi
if [ _n "$contrail_schema__DEFAULTS__disc_server_ip" ]; then
  ./openstack_config __set /etc/contrail/contrail_schema.conf DEFAULTS disc_server_ip $contrail_schema__DEFAULTS__disc_server_ip
fi
if [ _n "$contrail_schema__DEFAULTS__disc_server_port" ]; then
  ./openstack_config __set /etc/contrail/contrail_schema.conf DEFAULTS disc_server_port $contrail_schema__DEFAULTS__disc_server_port
fi
