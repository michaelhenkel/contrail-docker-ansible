...
if [ -n "$contrail_device_manager__DEFAULTS__log_file" ]; then
  ./openstack-config --set /etc/contrail/contrail-device-manager.conf DEFAULTS log_file $contrail_device_manager__DEFAULTS__log_file
fi
if [ -n "$contrail_device_manager__DEFAULTS__log_local" ]; then
  ./openstack-config --set /etc/contrail/contrail-device-manager.conf DEFAULTS log_local $contrail_device_manager__DEFAULTS__log_local
fi
if [ -n "$contrail_device_manager__DEFAULTS__log_level" ]; then
  ./openstack-config --set /etc/contrail/contrail-device-manager.conf DEFAULTS log_level $contrail_device_manager__DEFAULTS__log_level
fi
if [ -n "$contrail_device_manager__DEFAULTS__disc_server_ip" ]; then
  ./openstack-config --set /etc/contrail/contrail-device-manager.conf DEFAULTS disc_server_ip $contrail_device_manager__DEFAULTS__disc_server_ip
fi
if [ -n "$contrail_device_manager__DEFAULTS__disc_server_port" ]; then
  ./openstack-config --set /etc/contrail/contrail-device-manager.conf DEFAULTS disc_server_port $contrail_device_manager__DEFAULTS__disc_server_port
fi
